...
public class gui extends JFrame {
	...
	public gui() {
		...
		JLabel lblcashItem = new JLabel("New label");
		...
		JLabel lblNewLabel_29 = new JLabel("+$500");
		...
		JLabel lblNewLabel_18 = new JLabel("Cash:");
		...
		JLabel lblfertiliser = new JLabel("New label");
		lblfertiliser.setBounds(505, 70, 46, 14);
		itemPanel.add(lblfertiliser);
		
		JLabel lblirrigation = new JLabel("New label");
		lblirrigation.setBounds(521, 112, 30, 14);
		itemPanel.add(lblirrigation);
		
		JLabel lblseed = new JLabel("New label");
		...
		JButton btnseedDrills = new JButton("Buy Seed-Drills");
		...
		JButton btnirragation = new JButton("Buy Irrigation System");
		...
		JButton btnfertiliser = new JButton("Buy-Use Fertiliser");
		...
		JLabel lblNewLabel_22 = new JLabel("$40");
		...
		JLabel lblNewLabel_24 = new JLabel("$20");
